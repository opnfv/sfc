...
if __name__ == "__main__":
	...
	appTenantName = adminTenantName
	appTenantUser = adminTenantUser
	appTenantPass = adminTenantPass
	
	# 1 - Get the SF type
	SF_type = u"firewall"
	# 2 - Search the image in glance with that SF type
	image = OpenStack_API.find_image(SF_type)
	# 3 - Boot the VM without network
	name = "testVM"
	flavor = 1
	print("About to deploy")
	vm = OpenStack_API.create_vm(name,image,flavor)
	print vm
