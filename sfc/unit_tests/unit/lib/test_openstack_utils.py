...
class SfcOpenStackUtilsTesting(unittest.TestCase):
    ...
    def test_register_glance_image(self,
        ...
        mock_os_image_instance = mock_openstack_image.return_value
        mock_image_config_instance = mock_image_config.return_value
        log_calls = [call('Registering the image...'),
                     call('Registering the image...')]

        result = self.os_sfc.register_glance_image('name',
                                                   'url',
                                                   'img_format',
                                                   'public')
        assert result is mock_os_image_instance
        ...
        mock_openstack_image.assert_called_with(self.os_creds,
                                                mock_image_config_instance)
        mock_os_image_instance.create.assert_called_once_with()
        self.assertEqual([mock_os_image_instance], self.os_sfc.creators)
    ...
    def test_create_flavour(self,
        ...
        mock_openstack_flavor_instance = mock_openstack_flavor.return_value
        ...
        result = self.os_sfc.create_flavor('name',
                                           ...
                                           'disk',
                                           'vcpus')
        assert result is mock_openstack_flavor_instance.create()
        self.assertEqual([mock_openstack_flavor_instance],
                         self.os_sfc.creators)
        print(mock_flavor_config.mock_calls)
    ...
    def test_create_network_infrastructure(self,
        ...
        expected = (net_ins.create(), rou_ins.create())
    ...
    def test_create_security_group(self,
        ...
        assert result is oss_gro_ins.create()
    ...
    def test_create_instance(self,
        ...
        os_vm_ins_cre = os_vm_ins.create()
    ...
    def test_assign_floating_ip(self,
        ...
        flo_ip_inst = mock_floating_ip_config.return_value
        mock_os_vm_inst = mock_os_vm_ins.return_value
        mock_os_vm_inst.add_floating_ip.return_value = mock_ip
        ...
        mock_floating_ip_config.assert_called_once_with(name='mock_vm_name'
                                                        ...
                                                        router_name='mock_'
                                                        'router_name')
        mock_os_vm_inst.add_floating_ip.assert_called_once_with(flo_ip_inst)
    ...
    def test_assign_floating_ip_vnfs_raised_exception(self,
        ...
        ErrorMSG = "The VNF mock_server_1_name-float does not have any " \
                   "suitable port  for floating IP assignment"
        log_calls = [call(ErrorMSG)]

        self.os_sfc.image_settings = 'image_settings'
        mock_server_obj = Mock()
        mock_server_obj.name = 'mock_server_1_name'
        mock_port_obj = Mock()
    ...
    def test_assign_floating_ip_vnfs(self,
        ...
        get_sta_insts_calls = [call(self.heat, self.nova, self.neutron,
                                    self.keystone, 'stack_obj', 'admin')]

        gen_cre_insts_calls = [call(self.os_creds, mock_server_obj,
                                    'image_settings', 'admin')]
        ...
        mock_get_stack_servers.assert_has_calls(get_sta_insts_calls)
        mock_generate_creator.assert_has_calls(gen_cre_insts_calls)
    ...
    def test_get_client_port_raised_exceptioin(self,
        ...
        mock_vm = Mock()
        mock_vm.name = 'mock_vm_name'
        mock_os_vm_inst.get_port_by_name.return_value = None
        ...
        with self.assertRaises(Exception) as cm:
            self.os_sfc.get_client_port(mock_vm, mock_os_vm_inst)
    ...
    def test_get_client_port(self,
        ...
        mock_vm = Mock()
        mock_vm.name = 'mock_vm_name'
        mock_os_vm_inst.get_port_by_name.return_value = 'mock_port'
        result = self.os_sfc.get_client_port(mock_vm, mock_os_vm_inst)
...
def test_get_tacker_client(mock_tacker_client,
                           mock_env_file,
    ...
    mock_tacker_client_inst = mock_tacker_client.return_value
    result = os_sfc_utils.get_tacker_client()
    assert result is mock_tacker_client_inst
    ...
    mock_tacker_client.assert_called_once_with('1.0',
                                               session='keystone_session_obj')
...
class SfcTackerSectionTesting(unittest.TestCase):
    ...
    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.list', autospec=True)
    def test_get_id_from_name_returned_none(self,
                                            mock_list,
                                            mock_log):
        """
        ...
        path = '/' + collection
        mock_list.side_effect = Exception('ErrorMSG')
    ...
    def test_get_id_from_name(self,
        ...
        params = {'fields': 'id', 'name': resource_name}
        collection = resource_type + 's'
        mock_list.return_value = {collection: {0: {'id': 'mock_id'}}}
        path = '/' + collection
        result = os_sfc_utils.get_id_from_name(self.mock_tacker_client,
                                               resource_type,
                                               resource_name)
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.create_vnfd',
           autospec=True)
    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    def test_create_vnfd_returned_none(self,
        ...
        mock_create_vnfd.side_effect = Exception('ErrorMSG')
        mock_safe_load.side_effect = [Exception('LoadError'), 'mock_vnfd_body']
        ...
        self.mock_tacker_client.create_vnfd.assert_called_once_with(
            body={"vnfd": {"attributes": {"vnfd": "mock_vnfd"},
                  "name": "vnfd_name"}})
    ...
    def test_create_vnfd(self,
        ...
        result = os_sfc_utils.create_vnfd(self.mock_tacker_client,
                                          'tosca_file',
                                          'vnfd_name')
        assert result is mock_create_vnfd()
        self.mock_tacker_client.create_vnfd.assert_called_once_with(
            body={"vnfd": {"attributes": {"vnfd": "mock_vnfd"},
                           "name": "vnfd_name"}})
        mock_open.assert_called_once_with('tosca_file')
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.delete_vnfd',
           autospec=True)
    def test_delete_vnfd(self,
        ...
        result = os_sfc_utils.delete_vnfd(self.mock_tacker_client,
                                          None,
                                          'vnfd_name')
        assert result is mock_delete_vnfd()
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vnfs',
           autospec=True)
    def test_list_vnfs(self, mock_log):
        """
        Checks the proper functionality of list_vnfs
        function
        """
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.create_vnf',
           autospec=True)
    def test_create_vnf(self,
        ...
        function
        """
        body = {'vnf': {'attributes': {'param_values': 'mock_data'},
                        'vim_id': 'vim_id',
                        'name': 'vnf_name',
                        'vnfd_id': 'vnfd_id'}}
        ...
        result = os_sfc_utils.create_vnf(self.mock_tacker_client,
                                         ...
                                         'vim_name',
                                         'param_file')
        assert result is mock_create_vnf()
        mock_get_vnfd_id.assert_called_once_with(self.mock_tacker_client,
                                                 'vnfd_name')
        mock_get_vim_id.assert_called_once_with(self.mock_tacker_client,
                                                'vim_name')
        mock_log.info.assert_has_calls(log_calls)
        self.mock_tacker_client.create_vnf.assert_called_once_with(body=body)
    ...
    def test_wait_for_vnf_returned_none(self,
        ...
        log_calls = [call("Waiting for vnf {'status': 'ERROR', "
                          "'id': 'vnf_id'}"),
                     call("Waiting for vnf {'status': 'PEDNING_CREATE', "
                          "'id': 'vnf_id'}"),
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.delete_vnf',
           autospec=True)
    def test_delete_vnf(self,
        ...
        result = os_sfc_utils.delete_vnf(self.mock_tacker_client,
                                         None,
                                         'vnf_name')
        assert result is mock_delete_vnf()
        mock_get_vnf_id.assert_called_once_with(self.mock_tacker_client,
                                                'vnf_name')
        mock_delete_vnf.assert_called_once_with('vnf')

    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.create_vim',
           autospec=True, side_effect=Exception('ErrorMSG'))
    def test_create_vim_returned_none(self,
        ...
        self.assertIsNone(result)
        mock_create_vim.assert_called_once_with(None)
    ...
    def test_create_vim(self,
        ...
        assert result is mock_create_vim()
        mock_log.info.assert_has_calls(log_calls)
    ...
    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.create_vnffgd',
           autospec=True, side_effect=Exception('ErrorMSG'))
    def test_create_vnffgd_returned_none(self,
                                         mock_create_vnffgd,
                                         mock_log):
        """
    ...
    def test_create_vnffgd(self,
        ...
        result = os_sfc_utils.create_vnffgd(self.mock_tacker_client,
                                            'tosca_file',
                                            'vnffgd_name')
        assert result is mock_create_vnffgd()
        mock_open.assert_called_once_with('tosca_file')
        mock_safe_load.assert_called_once_with('mock_data')
        mock_create_vnffgd.assert_called_once_with(body)
        mock_log.info.assert_has_calls(log_calls)
        mock_log.error.assert_not_called()
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.create_vnffg',
           autospec=True)
    def test_create_vnffg(self,
        ...
        result = os_sfc_utils.create_vnffg(self.mock_tacker_client,
                                           ...
                                           'vnffgd_name',
                                           'param_file')
        assert result is mock_create_vnffg()
        ...
        result = os_sfc_utils.create_vnffg(self.mock_tacker_client,
                                           ...
                                           'param_file')
        assert result is mock_create_vnffg()
        print(mock_create_vnffg.mock_calls)
        mock_log.info.assert_has_calls(log_calls)
        mock_log.error.assert_not_called()
        mock_create_vnffg.assert_has_calls(vnffg_calls)

    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vnffgds',
           autospec=True, side_effect=Exception('ErrorMSG'))
    def test_list_vnffgds_returned_none(self,
                                        mock_list_vnffgds,
                                        mock_log):
        """
        ...
        self.assertIsNone(result)
        mock_list_vnffgds.assert_called_once_with(retrieve_all=True)
        mock_log.error.assert_has_calls(log_calls)

    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vnffgds',
           autospec=True)
    def test_list_vnffgds(self, mock_list_vnffgds):
        """
        ...
        mock_list_vnffgds.return_value = vnffgds
        result = os_sfc_utils.list_vnffgds(self.mock_tacker_client)
        self.assertEqual(mock_vnffgds, result)
        mock_list_vnffgds.assert_called_once_with(retrieve_all=True)

    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vnffgs',
           autospec=True,
           side_effect=Exception('ErrorMSG'))
    def test_list_vnffgs_returned_none(self,
                                       mock_list_vnffgs,
                                       mock_log):
        """
        ...
        self.assertIsNone(result)
        mock_list_vnffgs.assert_called_once_with('retrieve_all=True')
        mock_log.error.assert_has_calls(log_calls)

    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vnffgs',
           autospec=True)
    def test_list_vnffgs(self, mock_list_vnffgs):
        """
        Checks the proper functionality of list_vnffgs
        function
        """
        ...
        mock_list_vnffgs.return_value = vnffgs
        result = os_sfc_utils.list_vnffgs(self.mock_tacker_client)
    ...
    @patch('sfc.lib.openstack_utils.get_tacker_client.delete_vnffg',
           autospec=True, return_value='deleted')
    def test_delete_vnffg(self,
        ...
        mock_get_vnffg_id.assert_called_once_with(self.mock_tacker_client,
                                                  'vnffg_name')
        mock_delete_vnffg.assert_called_once_with('vnffg')
    ...
    @patch('sfc.lib.openstack_utils.get_vnffgd_id',
           autospec=True,
           return_value='vnffgd')
    @patch('sfc.lib.openstack_utils.get_tacker_client.delete_vnffgd',
           autospec=True,
    ...
    def test_delete_vnffgd(self,
        ...
        mock_get_vnffgd_id.assert_called_once_with(self.mock_tacker_client,
                                                   'vnffgd_name')
        mock_delete_vnffgd.assert_called_once_with('vnffgd')

    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vims',
           side_effect=Exception('ErrorMSG'))
    def test_list_vims_returned_none(self,
                                     mock_list_vims,
                                     mock_log):
        """
        ...
        self.assertIsNone(result)
        mock_list_vims.assert_called_once_with(retrieve_all=True)
        mock_log.error.assert_has_calls(log_calls)

    @patch('sfc.lib.openstack_utils.get_tacker_client.list_vims',
           autospec=True)
    def test_list_vims(self, mock_list_vims):
        """
        ...
        mock_list_vims.return_value = vims
        result = os_sfc_utils.list_vims(self.mock_tacker_client)
    ...
    def test_delete_vim_returned_none(self, mock_log):
        ...
        function when VIM id is not provided
        """

        log_calls = [call("Error [delete_vim(tacker_client, '%s', '%s')]: %s"
                     % (None, None, 'You need to provide VIM id or VIM name'))]
    ...
    @patch('sfc.lib.openstack_utils.get_vim_id',
           autospec=True, return_value='vim_id')
    @patch('sfc.lib.openstack_utils.get_tacker_client.delete_vim',
           autospec=True)
    def test_delete_vim(self,
        ...
        result = os_sfc_utils.delete_vim(self.mock_tacker_client,
                                         None,
                                         'vim_name')
        assert result is mock_delete_vim()
        mock_get_vim_id.assert_called_once_with(self.mock_tacker_client,
                                                'vim_name')
        self.mock_tacker_client.delete_vim.assert_called_once_with('vim_id')

    @patch('sfc.lib.openstack_utils.logger', autospec=True)
    def test_get_tacker_items(self, mock_log):
        """
        ...
        self.mock_tacker_client.assert_called_once()
