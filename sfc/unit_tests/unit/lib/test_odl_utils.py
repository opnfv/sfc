...
class SfcOdlUtilsTesting(unittest.TestCase):
    ...
    # def test_get_active_rsps_on_ports(self, mock_odl_acl_list):
    #     """
    ...
    #     port_one = Mock()
    #     port_two = Mock()
    #     port_one.id = 'id:port_one'
    #     port_two.id = 'id:port_two'
    #     neutron_ports = [port_one, port_two]

    #     odl_utils.get_active_rsps_on_ports('odl_ip', 'odl_port', neutron_ports)
    ...
    @patch('sfc.lib.odl_utils.get_active_rsps_on_ports', autospec=True)
    def test_check_vnffg_deletion(self, mock_active_rsps_on_ports,
                                  mock_actual_rsps,
                                  mock_find_compute,
                                  mock_log, mock_sleep):
        """
        ...
        mock_log.debug.assert_has_calls(log_calls[0])
