...
class SfcTestUtilsTesting(unittest.TestCase):
    ...
    def test_run_cmd(self,
        ...
        mock_subproc.Popen.return_value = pipe_mock
        result = test_utils.run_cmd(cmd)
        self.assertTupleEqual(result, (0, 'output', 'error'))
        mock_subproc.Popen.assert_called_once_with(cmd,
                                                   shell=True,
                                                   stdout=mock_subproc.PIPE,
                                                   stderr=mock_subproc.PIPE)
    ...
    def test_download_url_without_exception(self,
        ...
        mock_shutil.copyfileobj.assert_called_once_with(response, open_handler)
