...
class SfcTestUtilsTesting(unittest.TestCase):
    ...
    @patch('sfc.lib.test_utils.logger')
    @patch('sfc.lib.test_utils.subprocess.PIPE')
    @patch('sfc.lib.test_utils.subprocess.Popen')
    ...
    @patch('sfc.lib.test_utils.run_cmd')
    ...
    @patch('sfc.lib.test_utils.urllib.urlopen')
    @patch('sfc.lib.test_utils.shutil.copyfileobj')
    ...
    @patch('sfc.lib.test_utils.os.path.isfile', return_value=False)
    @patch('sfc.lib.test_utils.os.path.dirname', return_value='mocked_')
    @patch('sfc.lib.test_utils.os.path.basename', return_value='image_path')
    ...
    @patch('sfc.lib.test_utils.logger')
    @patch('sfc.lib.test_utils.download_url')
    @patch('sfc.lib.test_utils.os.path.isfile', return_value=True)
    @patch('sfc.lib.test_utils.os.path.dirname', return_value='mocked_')
    @patch('sfc.lib.test_utils.os.path.basename', return_value='image_path')
    ...
    @patch('sfc.lib.test_utils.logger')
    @patch('sfc.lib.test_utils.time.sleep')
    @patch('sfc.lib.test_utils.run_cmd_remote')
    ...
    @patch('sfc.lib.test_utils.netcat')
    ...
    @patch('sfc.lib.test_utils.time.strftime')
