...
class OpenStackSFC:
    ...
    def create_port_groups(self, vnf_port, vm_instance):
        ...
        ppg_parameter = {'port_pair_group': port_pair_group}
        port_pair_group_info = \
            self.neutron.create_sfc_port_pair_group(ppg_parameter)
    ...
    def create_chain(self, port_groups, neutron_port, port, protocol,
        ...
        sfc_classifier_params = {'name': vnffg_name + '-classifier',
                                 ...
                                 'protocol': protocol}
        fc_info = \
            self.neutron.create_sfc_flow_classifier(sfc_classifier_params)
