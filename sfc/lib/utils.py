...
# FIXME (jvidal): This is pure scaffolding, I do not have time right now
# to refactor the get_floating_ips to something that I feel comfortable with
# At least this should help run the testcase and see if it is in a good shape
# in order to pass MS6
