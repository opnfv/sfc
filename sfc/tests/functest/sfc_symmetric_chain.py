...
class SfcSymmetricChain(Common):
    ...
    def run(self):
        ...
        vvfn.create_custom_vnfd(COMMON_CONFIG, tacker_client, TESTCASE_CONFIG.test_vnfd, 'test-vnfd1')
        vvfn.create_custom_av(COMMON_CONFIG, tacker_client, vnf_names, 'test-vnfd1', '', topo_seed)
