...
class SfcSymmetricChain(sfc_parent_function.SfcCommonTestCase):
    ...
    def run(self):
        ...
        vnf_ip = os_sfc_utils.get_vnf_ip(self.tacker_client,
                                         vnf_id=self.vnf_id)
        sf_floating_ip = self.assign_floating_ip_sfs(vnf_ip)

        self.check_floating_ips(sf_floating_ip)

        self.start_services_in_vm(sf_floating_ip)

        self.vxlan_start_interface(sf_floating_ip, 'eth0', 'eth1', None)
        self.vxlan_start_interface(sf_floating_ip, 'eth1', 'eth0', None)
        ...
        self.vxlan_blocking_stop(sf_floating_ip)
        self.vxlan_start_interface(sf_floating_ip, 'eth0', 'eth1', "80")
        self.vxlan_start_interface(sf_floating_ip, 'eth1', 'eth0', None)
        ...
        self.vxlan_blocking_stop(sf_floating_ip)
        self.vxlan_start_interface(sf_floating_ip, 'eth0', 'eth1', None)
        self.vxlan_start_interface(sf_floating_ip, 'eth1', 'eth0',
