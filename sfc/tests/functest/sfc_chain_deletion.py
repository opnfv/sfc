...
class SfcChainDeletion(Common):
    ...
    def run(self):
        ...
        vvfn1.create_custom_av(COMMON_CONFIG, tacker_client, vnf_names[0], 'test-vnfd1', 'test-vim', topo_seed)

        vvfn1.create_chain(COMMON_CONFIG, TESTCASE_CONFIG, client_instance, client_creator)
        ...
        vvfn1.remove_vnff(tacker_client, 'red_http', 'red')
        vvfn1.check_deletion(odl_ip, odl_port, ovs_logger, compute_nodes, openstack_sfc.get_compute_client)
        ...
        results, verdict_allowed_http = vvfn1.present_results_allowed_http(COMMON_CONFIG, client_floating_ip,
        ...
        results, verdict = vvfn1.present_results_http(COMMON_CONFIG, client_floating_ip, server_instance, ovs_logger,
                                                      deployment_handler, compute_nodes)
