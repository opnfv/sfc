...
class CommonTestCase:
    ...
    def block_http_trafic(self, sf1_floating_ip, sf2_floating_ip, client_floating_ip, ovs_logger, controller_clients,
    ...
    def present_results_allowedport_http(self, COMMON_CONFIG, TESTCASE_CONFIG, client_floating_ip, server_instance, ovs_logger, deployment_handler,
                             compute_nodes):
    ...
    def present_results_allowed_http(self, COMMON_CONFIG, client_floating_ip, server_instance, ovs_logger, deployment_handler,
                             compute_nodes):
