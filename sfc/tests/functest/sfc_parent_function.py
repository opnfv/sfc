...
class CommonTestCase():
    ...
    def preparation_vnfd(self, COMMON_CONFIG, TESTCASE_CONFIG, logger, supported_installers):
        ...
        return ovs_logger, network, router, sg

    def create_custom_vnfd (self, COMMON_CONFIG, TESTCASE_CONFIG, tacker_client, test_case_name, vnfd_name):
        ...
        if test_case_name == 'red':
            tosca_file = os.path.join(COMMON_CONFIG.sfc_test_dir,
                                 COMMON_CONFIG.vnfd_dir,
                                 TESTCASE_CONFIG.test_vnfd_red)
        elif test_case_name == 'blue':
            tosca_file = os.path.join(COMMON_CONFIG.sfc_test_dir,
                                     COMMON_CONFIG.vnfd_dir,
    ...
    def prepare_router(self, TESTCASE_CONFIG):
    ...
    def prepare_client_elements (self, COMMON_CONFIG, TESTCASE_CONFIG, CLIENT, vnf_names, topo_seed):
        ...
        return client_instance, client_creator

    def prepare_server_elements (self, COMMON_CONFIG, TESTCASE_CONFIG, SERVER, vnf_names, topo_seed):
        ...
        return server_instance, server_creator
    ...
    def present_results_ssh(self, COMMON_CONFIG, server_instance, deploymentHandler, compute_nodes, client_floating_ip, ovs_logger):
    ...
    def remove_vnff(self, tacker_client):
    ...
    def present_results_http(self, COMMON_CONFIG, client_floating_ip, server_instance, ovs_logger, deploymentHandler, compute_nodes):
    ...
    def installer_deployment_odl(self, COMMON_CONFIG):
        ...
        return odl_ip, odl_port, deploymentHandler


    def prepare_extra_variables(self, COMMON_CONFIG, compute_nodes, controller_nodes, vnfs):
        ...
        return compute_clients, controller_clients, testTopology, topo_seed, custom_flv, ovs_logger
