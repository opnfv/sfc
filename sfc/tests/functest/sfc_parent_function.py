...
class SfcCommonTestCase(object):
    ...
    def prepare_env(self, testcase_config, supported_installers):
        ...
        self.openstack_nodes = \
            (deployment_handler.get_nodes({'cluster': cluster})
    ...
    def prepare_server_client_vm(self, vnf_names):
        ...
        self.server_ip = server_instance.ports[0].ips[0]['ip_address']
    ...
    def create_chain(self, testcase_config):
        ...
        self.neutron_port = openstack_sfc.get_client_port(client_instance,
                                                          client_creator)
