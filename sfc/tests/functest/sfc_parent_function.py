...
class CommonTestCase:
    ...
    def preparation_openstack(self, common_config, testcase_config, logger, supported_installers):
        ...
        return ovs_logger, network, router, sg, image_creator, openstack_sfc.creators
    ...
    def create_custom_av(self, common_config, tacker_client, vnf_names, av_member1, av_member2, test_topology):
    ...
    def prepare_server_client_elements(self, common_config, image_creator, vnf_names, topo_seed, network, sg):
    ...
    def path_join(self, common_config, testcase_config, tacker_client, client_instance, client_creator, vnf_name,
                  conn_name):
        ...
        neutron_port = openstack_sfc.get_client_port(client_instance, client_creator)
    ...
    def present_results_allowedport_http(self, common_config, testcase_config, client_floating_ip, server_instance,
    ...
    def create_chain(self, common_config, testcase_config, client_instance, client_creator):
    ...
    def check_deletion(self, odl_ip, odl_port, ovs_logger, compute_nodes, openstack_client):
    ...
    def present_results_allowed_http(self, common_config, client_floating_ip, server_instance, ovs_logger,
