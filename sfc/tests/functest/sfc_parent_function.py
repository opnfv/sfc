...
class SfcCommonTestCase(object):
    ...
    def assign_floating_ip_sfs(self, vnf_ip=None):
        ...
        fips_sfs_size = len(fips_sfs)
        if fips_sfs_size == 2:
            sf1_floating_ip = fips_sfs[0]
            sf2_floating_ip = fips_sfs[1]
            return sf1_floating_ip, sf2_floating_ip
        elif fips_sfs_size == 1:
            sf1_floating_ip = fips_sfs[0]
            return sf1_floating_ip

    def check_floating_ips(self, sf1_floating_ip, sf2_floating_ip=None):
        """
    ...
    def start_services_in_vm(self, sf1_floating_ip, sf2_floating_ip=None):
        """
        ...
        if sf2_floating_ip is None:
            for sf_floating_ip in sf1_floating_ip:
