...
def main():
    ...
    client_instance, client_cretor = openstack_sfc.create_instance(
    ...
    client_ip = client_instance.ports[0].ips[0]['ip_address']
    ...
    server_floating_ip = openstack_sfc.assign_floating_ip(router,
                                                          server_instance)
    sf1_floating_ip, sf2_floating_ip = openstack_sfc.assign_floating_ip_vnfs(
        router)
