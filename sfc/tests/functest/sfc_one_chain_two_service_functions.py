...
def main():
    ...
    image = openstack_sfc.register_glance_image(COMMON_CONFIG.image_name,
    ...
    client_instance = openstack_sfc.create_instance(
        CLIENT, COMMON_CONFIG.flavor, image, network, sg,
        av_zone=testTopology['client'])

    server_instance = openstack_sfc.create_instance(
        SERVER, COMMON_CONFIG.flavor, image, network, sg,
