...
class SfcTwoChainsSSHandHTTP:
    ...
    def run(self):
        ...
        vvfn2.create_custom_av(COMMON_CONFIG, tacker_client, vnf_names[1], 'test-vnfd2', 'test-vim', topo_seed)
        ...
        vvfn1.remove_vnff(tacker_client, 'red_http_works', 'red')

        vvfn2.path_join(COMMON_CONFIG, TESTCASE_CONFIG, tacker_client, client_instance, 'blue', 'blue_ssh')
