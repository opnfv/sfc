...
The os-odl-sfc-fdio-ha is intended to be used to install the OPNFV SFC project in a standard
...
and SFC configuraiton with OpenStack and OpenDaylight SFC project.
