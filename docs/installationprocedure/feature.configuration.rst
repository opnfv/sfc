...
-`OpenDayLight SFC with High Availability<http://artifacts.opnfv.org/sfc/colorado/docs/scenarios_os-odl_l2-sfc-ha/index.html>`_

- `OpenDayLight SFC without High Availability<http://artifacts.opnfv.org/sfc/colorado/docs/scenarios_os-odl_l2-sfc-noha/index.html>`_
...
`hardware specification<http://artifacts.opnfv.org/pharos/docs/pharos-spec.html>`_ for configuring your hardware.
